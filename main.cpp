...
int main(int argc, char* argv[]) {
    ...
    if (argc == 2 && std::strcmp(argv[1], "unittest") == 0) {
        ...
        //logging.init(N, "../tests/test_grad_gauss");
        UnitTests::LoggerSphereMaxGrad logging;
        logging.init(N, "../tests/test_sphere_grad_gauss");
        ...
        logging.init(N, "../tests/test_direct_problem", true);
        Data::init_rays(rank, v0, cone_rad, rays, tubes);
        DirectProblem::DPSolver direct_problem{};
        //direct_problem.init(0.02, N, true, 3);
        direct_problem.init(0.02, N, false);
